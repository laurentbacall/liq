...
def get_master_data():
    ...
    if not df_main.empty:
        ...
        # Use YF for history, FRED for recent gap fill
...
if not df.empty:
    ...
    df['M2_Real_Level'] = df['M2'] / (df['CPI'] / 100) # Restoration of level
